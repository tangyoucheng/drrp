package cn.com.prescription.framework.qrcode.web;
...
import cn.com.prescription.framework.qrcode.ErrorCorrectLevel;
import cn.com.prescription.framework.qrcode.QRCode;

/**
 * QRコードサーブレット.
 * <br>
 * QRコードのモノクロGIF画像を応答するサーブレットです。
 * <br>
 * [パラメータ]
 * <br>
 ...
 * <br>
 * s : セルサイズ (1～4, 省略した場合は 1)
 * 
 * @author Kazuhiko Arase
 * @see cn.com.prescription.framework.qrcode.Mode
 * @see cn.com.prescription.framework.qrcode.ErrorCorrectLevel
 */
