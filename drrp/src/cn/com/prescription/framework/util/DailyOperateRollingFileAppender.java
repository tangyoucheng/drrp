 ...
 */
@Plugin(name = DailyOperateRollingFileAppender.PLUGIN_NAME, category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class DailyOperateRollingFileAppender extends AbstractOutputStreamAppender<RollingFileManager> {

    public static final String PLUGIN_NAME = "DailyOperateRollingFile";
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
                    implements org.apache.logging.log4j.core.util.Builder<DailyOperateRollingFileAppender> {
        ...
        @Override
        public DailyOperateRollingFileAppender build() {
            ...
            if (strategy == null) {
                ...
                LOGGER.error(
                    "RollingFileAppender '{}': When no file name is provided a DirectFilenameRolloverStrategy must be configured");
                return null;
            }
            ...
            return new DailyOperateRollingFileAppender(getName(), layout, getFilter(), manager, fileName, filePattern,
    ...
    private DailyOperateRollingFileAppender(final String name, final Layout<? extends Serializable> layout,
