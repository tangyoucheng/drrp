 ...
 */
@Plugin(name = DailyRollingFileAppender.PLUGIN_NAME, category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class DailyRollingFileAppender extends AbstractOutputStreamAppender<RollingFileManager> {

    public static final String PLUGIN_NAME = "DailyRollingFile";
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
                    implements org.apache.logging.log4j.core.util.Builder<DailyRollingFileAppender> {
        ...
        @Override
        public DailyRollingFileAppender build() {
            ...
            return new DailyRollingFileAppender(getName(), layout, getFilter(), manager, fileName, filePattern,
    ...
    private DailyRollingFileAppender(final String name, final Layout<? extends Serializable> layout,
