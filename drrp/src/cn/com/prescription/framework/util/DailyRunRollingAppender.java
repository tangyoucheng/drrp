 ...
 * @author bpchikazawa
 */
public class DailyRunRollingAppender extends RollingFileAppender {
    ...
    private void deleteOldFile(Date _nowDate) {
        try {
            ...
            // ログ保存期間
            int saveRange_ = NumberUtils.toInt(StandardConstantsIF.KYOTU_EXECUTE_LOG_SAVE_KIKAN_MONTH_SU);
    ...
    private String getDateFileName(Date _logDate) {
        ...
        // ファイル名生成
        return new File(StandardConstantsIF.KYOTU_EXECUTE_LOG_SAVE_FOLDER_ROOT_PATH, newFile_).getAbsolutePath();
