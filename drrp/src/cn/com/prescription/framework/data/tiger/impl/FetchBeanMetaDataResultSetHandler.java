...
public class FetchBeanMetaDataResultSetHandler extends AbstractBeanMetaDataResultSetHandler {
    ...
    public FetchBeanMetaDataResultSetHandler(BeanMetaData beanMetaData, RowCreator rowCreator,
                    RelationRowCreator relationRowCreator, FetchHandler<?> fetchHandler) {
