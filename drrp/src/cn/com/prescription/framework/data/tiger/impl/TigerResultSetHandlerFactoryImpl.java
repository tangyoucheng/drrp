...
import cn.com.prescription.framework.data.s2dao.ResultSetHandlerFactoryImpl;
...
public class TigerResultSetHandlerFactoryImpl extends ResultSetHandlerFactoryImpl {
    ...
    @Override
    public ResultSetHandler getResultSetHandler(DaoAnnotationReader daoAnnotationReader, BeanMetaData beanMetaData,
                    Method method) {
        ...
        return super.getResultSetHandler(daoAnnotationReader, beanMetaData, method);
    }
    ...
    protected ResultSetHandler createFetchResultSetHandler(final Class beanClass, final BeanMetaData beanMetaData) {
        return new FetchResultSetHandler(beanClass, beanMetaData, dtoMetaDataFactory);
    }
