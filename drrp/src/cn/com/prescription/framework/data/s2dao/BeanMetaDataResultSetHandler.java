...
public class BeanMetaDataResultSetHandler extends AbstractBeanMetaDataResultSetHandler {
    ...
    private static final Logger logger = Logger.getLogger(BeanMetaDataResultSetHandler.class);
     ...
     */
    public BeanMetaDataResultSetHandler(BeanMetaData beanMetaData, RowCreator rowCreator,
    ...
    public Object handle(ResultSet resultSet) throws SQLException {
        if (resultSet.next()) {
            ...
            for (int i = 0; i < getBeanMetaData().getRelationPropertyTypeSize(); ++i) {
                ...
                RelationKey relKey = createRelationKey(resultSet, rpt, columnNames, relKeyValues);
                Object relationRow = null;
                if (relKey != null) {
                    relationRow = createRelationRow(resultSet, rpt, columnNames, relKeyValues, relationPropertyCache);
                }
                if (relationRow != null) {
