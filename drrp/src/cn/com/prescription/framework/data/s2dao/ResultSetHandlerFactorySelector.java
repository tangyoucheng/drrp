...
public class ResultSetHandlerFactorySelector implements ResultSetHandlerFactory {
    ...
    private static final String TIGER_RESULT_SET_HANDLER_FACTORY = "cn.com.prescription.framework.data.tiger.impl.TigerResultSetHandlerFactoryImpl";
    ...
    public void init() {
        ...
        ResultSetHandlerFactoryImpl factory = (ResultSetHandlerFactoryImpl) ClassUtil.newInstance(clazz);
    ...
    public ResultSetHandler getResultSetHandler(DaoAnnotationReader daoAnnotationReader, BeanMetaData beanMetaData,
                    Method method) {
        return resultSetHandlerFactory.getResultSetHandler(daoAnnotationReader, beanMetaData, method);
    }
