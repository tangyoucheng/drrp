 ...
 */
public interface RpmPatient01Dao extends DAO {

    /**
     * 患者基本信息表BEAN
     */
    Class<?> BEAN = RpmPatient01Model.class;
     ...
     * @return 取得結果
     */
    long selectPatientListCount(RpmPatient01Condition _condition);
     ...
     * @return 取得結果
     */
    List<RpmPatient01Model> selectPatientList(RpmPatient01Condition _condition);
     ...
     * @return 取得結果
     */
    RpmPatient01Model selectPrescriptionInfo(RpmPatient01Condition _condition);
