 ...
 */
public interface RpmMenuDao extends DAO {

    /**
     * 菜?基本信息表BEAN
     */
    Class<?> BEAN = RpmMenuModel.class;
     ...
     * @return 登録件数
     */
    int insert(RpmMenuModel _model);
     ...
     * @return 登録件数
     */
    int update(RpmMenuModel _model);
     ...
     * @return 登録件数
     */
    int updateUnlessNull(RpmMenuModel _model);
     ...
     * @return 削除件数
     */
    int delete(RpmMenuModel _model);
     ...
     * @return 取得結果
     */
    RpmMenuModel select(RpmMenuCondition _condition);
     ...
     * @return 取得結果
     */
    List<RpmMenuModel> selectList(RpmMenuCondition _condition);

    /**
     * 排他処理の菜?基本信息表のデータを取得する。
     * <p>
     * 指定された条件の単一データの取得を行う。<br>
     * 条件はデータベーステーブルの主キーとなる項目。<br>
     * sqlはS2Daoにて自動生成される。<br>
     ...
     */
    RpmMenuModel selectForUpdate(RpmMenuCondition _condition) throws DbExclusiveException;
     ...
     * @return 取得結果
     */
    List<RpmMenuModel> selectBySort(RpmMenuCondition _condition);
     ...
     * </p>
     */
    @Sql("LOCK TABLE RPM_MENU IN EXCLUSIVE MODE NOWAIT")
