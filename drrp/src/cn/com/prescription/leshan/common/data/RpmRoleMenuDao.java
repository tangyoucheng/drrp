 ...
 */
public interface RpmRoleMenuDao extends DAO {
     ...
     * @return 登録件数
     */
    int insert(RpmRoleMenuModel _model);
     ...
     * @return 登録件数
     */
    int update(RpmRoleMenuModel _model);
     ...
     * @return 登録件数
     */
    int updateUnlessNull(RpmRoleMenuModel _model);
     ...
     * @return 削除件数
     */
    int delete(RpmRoleMenuModel _model);
     ...
     * @return 取得結果
     */
    RpmRoleMenuModel select(RpmRoleMenuCondition _condition);
     ...
     * @return 取得結果
     */
    List<RpmRoleMenuModel> selectList(RpmRoleMenuCondition _condition);

    /**
     * 排他処理の角色?限信息表のデータを取得する。
     * <p>
     * 指定された条件の単一データの取得を行う。<br>
     * 条件はデータベーステーブルの主キーとなる項目。<br>
     * sqlはS2Daoにて自動生成される。<br>
     ...
     */
    RpmRoleMenuModel selectForUpdate(RpmRoleMenuCondition _condition) throws DbExclusiveException;
     ...
     * @return 取得結果
     */
    List<RpmRoleMenuModel> selectBySort(RpmRoleMenuCondition _condition);
     ...
     * </p>
     */
    @Sql("LOCK TABLE RPM_ROLE_MENU IN EXCLUSIVE MODE NOWAIT")
