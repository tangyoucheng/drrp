 ...
 */
public interface RpmOutpatientDao extends DAO {

    /**
     * 门诊信息EAN
     */
    Class<?> BEAN = RpmOutpatientModel.class;
     ...
     * @return 登録件数
     */
    int insert(RpmOutpatientModel _model);
     ...
     * @return 登録件数
     */
    int update(RpmOutpatientModel _model);
     ...
     * @return 登録件数
     */
    int updateUnlessNull(RpmOutpatientModel _model);
     ...
     * @return 削除件数
     */
    int delete(RpmOutpatientModel _model);
     ...
     * @return 取得結果
     */
    RpmOutpatientModel select(RpmOutpatientCondition _condition);
     ...
     * @return 取得結果
     */
    List<RpmOutpatientModel> selectList(RpmOutpatientCondition _condition);
     ...
     */
    RpmOutpatientModel selectForUpdate(RpmOutpatientCondition _condition) throws DbExclusiveException;
     ...
     * @return 取得結果
     */
    List<RpmOutpatientModel> selectBySort(RpmOutpatientCondition _condition);
     ...
     * </p>
     */
    @Sql("LOCK TABLE RPM_OUTPATIENT IN EXCLUSIVE MODE NOWAIT")
