 ...
 */
public interface RpmRoleDao extends DAO {
     ...
     * @return 登録件数
     */
    int insert(RpmRoleModel _model);
     ...
     * @return 登録件数
     */
    int update(RpmRoleModel _model);
     ...
     * @return 登録件数
     */
    int updateUnlessNull(RpmRoleModel _model);
     ...
     * @return 削除件数
     */
    int delete(RpmRoleModel _model);
     ...
     * @return 取得結果
     */
    RpmRoleModel select(RpmRoleCondition _condition);
     ...
     * @return 取得結果
     */
    List<RpmRoleModel> selectList(RpmRoleCondition _condition);
     ...
     */
    RpmRoleModel selectForUpdate(RpmRoleCondition _condition) throws DbExclusiveException;
     ...
     * @return 取得結果
     */
    List<RpmRoleModel> selectBySort(RpmRoleCondition _condition);
     ...
     * </p>
     */
    @Sql("LOCK TABLE RPM_ROLE IN EXCLUSIVE MODE NOWAIT")
