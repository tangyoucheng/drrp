...
import cn.com.prescription.leshan.rpc.data.RPC00103Dao;
...
/**
 * 门诊信息添加初期化处理。 新規作成 DATE: 2016.03.24 NAME: tyc
 */
public class RPC00103InitLogic extends StandardBiz implements StandardLogic {
	/**
	 * 初诊更新 DAO
	 */
	private RPC00103Dao rpc00103Dao = null;

	/**
	 * 门诊信息設定画面 初期化業務クラス的构造。
	 */
	public RPC00103InitLogic() {
		super();
	}
	...
	public StandardEventResult service(StandardEvent _event) throws ApplicationException, SystemException {
		...
		RPC00103Condition condition_ = new RPC00103Condition();
		// 用户ID
		condition_.setRecordId(inForm_.getRecordId());
		// 消除标识＝ [定数：消除标识．有効レコード]
		condition_.setDeleteFlag(LeshanConstantsIF.DEL_FLG_YUKO_RECORD);
		// [排他情報：用户プロファイル情報]
		RPC00103Model model_ = rpc00103Dao.selectOutpatientInfo(condition_);
		if (model_ != null) {
	...
	/**
	 * 初诊更新 DAO的设定
	 * @param _rpc00103Dao 初诊更新 DAO
	 */
	public void setRpc00103Dao(RPC00103Dao _rpc00103Dao) {
	    this.rpc00103Dao = _rpc00103Dao;
	}
