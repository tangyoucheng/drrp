 ...
 */
public class RPC00103Form extends AbstractForm {
	...
	/**
	 * 所有权("T":具有所有权"F":不具有所有权;)的取得
	 * @return 所有权("T":具有所有权"F":不具有所有权;)
	 */
	...
	/**
	 * 所有权("T":具有所有权"F":不具有所有权;)的设定
	 * @param _ownershipFlag 所有权("T":具有所有权"F":不具有所有权;)
	 */
	public void setOwnershipFlag(String _ownershipFlag) {
	    this.ownershipFlag = _ownershipFlag;
	}
