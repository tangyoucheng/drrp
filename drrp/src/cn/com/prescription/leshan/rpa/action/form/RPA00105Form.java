 ...
 */
public class RPA00105Form extends AbstractForm {
     ...
     * 第一次 审核标识
     */
    private String firstReviewFlag;
     ...
     * subForm1
     */
    private List<RPA0010501Dto> subForm1 = new ArrayList<RPA0010501Dto>();
    ...
    /**
     * 身份证号码的设定
     * @param __idNumbe 身份证号码
     */
    public void setIdNumbe(String _idNumbe) {
        this.idNumbe = _idNumbe;
    }
     ...
     * @return 第一次 审核标识
     */
    public String getFirstReviewFlag() {
        return firstReviewFlag;
    }

    /**
     * 第一次 审核标识的设定
     * @param __firstReviewFlag 第一次 审核标识
     */
    public void setFirstReviewFlag(String _firstReviewFlag) {
        this.firstReviewFlag = _firstReviewFlag;
    }
    ...
    /**
     * 处方编号的设定
     * @param __prescriptionNumber 处方编号
     */
    public void setPrescriptionNumber(String _prescriptionNumber) {
        this.prescriptionNumber = _prescriptionNumber;
    }
     ...
     * @return subForm1
     */
    public List<RPA0010501Dto> getSubForm1() {
        return subForm1;
    }
     ...
     */
    public void setSubForm1(List<RPA0010501Dto> _subForm1) {
