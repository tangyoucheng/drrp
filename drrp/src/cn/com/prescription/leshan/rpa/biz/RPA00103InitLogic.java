 ...
 */
public class RPA00103InitLogic extends StandardBiz implements StandardLogic {

    /**
     * 患者DAO
     */
    private RpmPatient01Dao rpmPatient01Dao = null;
    ...
    /**
     * RPA00103InitLogic的构造。
     */
    public RPA00103InitLogic() {
        super();
    }
    ...
    public StandardEventResult service(StandardEvent _event) throws ApplicationException, SystemException {
        ...
        if (rpmPatient01Model != null) {
            ...
            // 身份证号码
            inForm_.setIdNumber(rpmPatient01Model.getIdNumber());
            // 手机号码
            ...
            // 处方配药者
            // 处方配药者名
            inForm_.setDispenseUserName(rpmPatient01Model.getPrescriptionCreateUserName());
            // 处方审核者
            // 处方审核者名
            inForm_.setConfirmUserName(rpmPatient01Model.getPrescriptionCreateUserName());
            // 门诊/住院号
        ...
        if (returnList != null && !returnList.isEmpty()) {
            List<RPA0010301Dto> _subForm1 = new ArrayList<RPA0010301Dto>();
            for (RpmPrescriptionDrug01Model rpmPrescriptionDrug01Model : returnList) {
                RPA0010301Dto rpa0010301Dto = new RPA0010301Dto();
                rpa0010301Dto.setDrugId(rpmPrescriptionDrug01Model.getDrugId());
                rpa0010301Dto.setDrugName(rpmPrescriptionDrug01Model.getDrugName());
                rpa0010301Dto.setManufacturerName(rpmPrescriptionDrug01Model.getManufacturerName());
                rpa0010301Dto.setPrice(rpmPrescriptionDrug01Model.getPrice());
                rpa0010301Dto.setQuantity(rpmPrescriptionDrug01Model.getQuantity());
                _subForm1.add(rpa0010301Dto);
            }
