...
import cn.com.prescription.leshan.rpa.action.form.RPA0030401Dto;
 ...
 */
public class RPA00304SearchLogic extends StandardBiz implements StandardLogic {
    ...
    public StandardEventResult service(StandardEvent _event) throws ApplicationException, SystemException {
        ...
        // event処理結果
        RPA00304Form inForm_ = (RPA00304Form) _event.getForm();
        ...
        for (RpmDrug01Model rpmPatientModel : roleModelList_) {
            RPA0030401Dto rpa0030401Dto = new RPA0030401Dto();
            rpa0030401Dto.setDrugId(rpmPatientModel.getDrugId());
            rpa0030401Dto.setDrugName(rpmPatientModel.getDrugName());
            rpa0030401Dto.setManufacturerName(rpmPatientModel.getManufacturerName());
            rpa0030401Dto.setPrice(rpmPatientModel.getPrice());
            rpa0030401Dto.setUnit(rpmPatientModel.getUnit());
            rpa0030401Dto.setNotes(rpmPatientModel.getNotes());
            inForm_.getSubForm1().add(rpa0030401Dto);
        }
