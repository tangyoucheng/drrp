                        ...
                        <table id="tablecloth_row1" class="row_table" style="width: 720px;margin-left: 0px">
                            ...
                            <s:iterator status="listData" value="rpa00204Form.subForm1">
                                <tr id="patientTr_<g:property value="#listData.index"/>" onclick="setSelectedTrColor(this);">
                                    ...
                                    <!-- 用户名  -->
                                    <td title="<s:property value="#rpa0020401Dto.userName" /> " class="txt_overflow">
                                            <s:property value="#rpa0020401Dto.userName" /> 
                                            <s:hidden name="rpa00204Form.subForm1[%{#listData.index}].userName" />
                                    </td>
                                    <!-- 手机号码  -->
                                    <td title="<s:property value="#rpa0020401Dto.ceelNumber" /> " class="txt_overflow">
                                            <s:property value="#rpa0020401Dto.ceelNumber" /> 
                                            <s:hidden name="rpa00204Form.subForm1[%{#listData.index}].ceelNumber" />
                                    </td>
                                    <!-- 座机号码  -->
                                    <td title="<s:property value="#rpa0020401Dto.phoneNumber" /> " class="txt_overflow">
                                            <s:property value="#rpa0020401Dto.phoneNumber" /> 
                                            <s:hidden name="rpa00204Form.subForm1[%{#listData.index}].phoneNumber" />
                                    </td>
                                    <!-- 上次处方时间  -->
                                    <td title="<s:property value="#rpa0020401Dto.prescriptionCreateDate" /> " class="txt_overflow">
                                            <s:property value="#rpa0020401Dto.prescriptionCreateDate" /> 
