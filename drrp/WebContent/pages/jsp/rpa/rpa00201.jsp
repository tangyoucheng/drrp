            ...
            <div id="two_main_colum">
                ...
                <table class="entry_content_table gamen_layout1">
                    <tr>
                        ...
                        <td style="width: 75px;">
                            <s:textfield id="nation" name="rpa00201Form.nation" style="width:75px;" maxlength="5" cssErrorClass="error" />
                        </td>
                        <!-- 婚况 -->
                        <td style="text-align: right; width: 60px; padding-top: 5px;">婚况：</td>
                        <td>
                            <s:textfield id="maritalStatus" name="rpa00201Form.maritalStatus" style="width:40px;" maxlength="2" cssErrorClass="error" />
                        </td>
                    </tr>
                </table>
                <table class="entry_content_table gamen_layout1">
                    ...
                    <tr>
                        ...
                        <td>
                            <h:readonlyfield id="birthday_age" name="rpa00201Form.age" style="text-align: right;width:20px;" />
                            岁
                        </td>
                        <td>
                ...
                <table class="entry_content_table gamen_layout1">
                    <tr>
                        ...
                        <td style="width: 130px;">
                            <h:time form="rpa00201Form" id="timeOfBirth" timeValue="timeOfBirth"></h:time>
                        </td>
                        <!-- 阴历生日 -->
                        <td style="text-align: right; width: 70px; padding-top: 5px;">阴历生日：</td>
                        <td style="width: 170px;">
                            <h:calendar form="rpa00201Form" id="lunarBirthday" dateValue="lunarBirthday"></h:calendar>
                        </td>
                        <!-- 属相 -->
                        <td style="text-align: right; width: 60px; padding-top: 5px;">属相：</td>
                        <td>
                            <s:textfield id="zodiac" name="rpa00201Form.zodiac" style="width:40px;" maxlength="1" cssErrorClass="error" />
                        </td>
                    </tr>
                </table>
                <table class="entry_content_table gamen_layout1">
                    <tr>
                        ...
                        <td></td>
                        <td colspan="4">
                            <s:textfield id="placeOfBirth" name="rpa00201Form.placeOfBirth" style="width:400px;" maxlength="400"></s:textfield>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <s:textfield id="phoneNumber" name="rpa00201Form.phoneNumber" style="width:160px;" maxlength="11" cssErrorClass="error"></s:textfield>
                        </td>
                    </tr>
                    <tr>
                        <!-- 身份证号码-->
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td colspan="4">
                            <s:textfield id="company" name="rpa00201Form.company" style="width:400px;" maxlength="400"></s:textfield>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td colspan="4">
                            <s:textfield id="profession" name="rpa00201Form.profession" style="width:400px;" maxlength="400"></s:textfield>
                        </td>
                        <td></td>
                    </tr>
                </table>
