            ...
            <div id="two_main_colum">
                ...
                <table class="entry_content_table input_condition">
                    ...
                    <tr>
                        ...
                        <td>
                            <A class="aid_btn" id=rpa00304Action_doSearch_ onclick="return submitUrl(function() {doClearWaterMark();},$(this));"
                                href="<%=request.getContextPath()%>/rpa00304Action!doSearch.do">
                                <span>呼出</span>
                            </A>
                        </td>
                    </tr>
