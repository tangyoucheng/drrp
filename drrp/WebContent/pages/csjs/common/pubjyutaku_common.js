...
$.ajaxSetup({
    type : "post",
    dataType : "json",
//    async:false, // 与jquery.fileupload 冲突
...
//================================================
//年齢の計算
//【入力】選択した日付(YYYY年MM月ＤＤ日)
//【返却】なし
//【作成】t.d.m
//【更新】
//【概要】
//================================================
function getAgeByBirthday(_birthday) {
     var _returnAge;
     var birthdayOBjectValue = _birthday.replace('年','/').replace('月','/').replace('日','');
     // 年齢の計算
...
//【 概要 】なし
//================================================
function setTableHover(trInfo) {
 $("#" + trInfo.id + ' td').addClass("hover");
}// ================================================
//選択したTRの着色設定
//【 入力 】なし
//【返却値】なし
...
//【 概要 】なし
//================================================
function clearTableHover(trInfo) {
 $("#" + trInfo.id + ' td').removeClass("hover");
}
